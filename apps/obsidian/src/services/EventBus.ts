...
export class EventBus {
  ...
  on<K extends keyof EventPayload>(event: K, listener: (payload: EventPayload[K]) => void): void {
    this.emitter.on(event, listener)
  }

  off<K extends keyof EventPayload>(event: K, listener: (payload: EventPayload[K]) => void): void {
