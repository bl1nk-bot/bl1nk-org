...
import type { MCPServer, Project, Skill, Tool } from "../types/index.types"
import {
  type PluginStore,
  resolveMCPServers,
  resolveSkills,
...
export class ProjectManager {
  ...
  createProject(input: { name: string; description?: string; vaultPath?: string }): Project {
  ...
  deleteProject(projectId: string): boolean {
    ...
    this.store.sessions = this.store.sessions.filter((s) => s.projectId !== projectId)
