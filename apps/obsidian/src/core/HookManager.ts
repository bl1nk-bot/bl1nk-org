import { Project, Hook, HookEvent, HookAction } from "../types/index.types";
import { PluginStore } from "../types/store.types";
import { EventBus } from "../services/EventBus";
import { Logger } from "../services/Logger";
import { ProjectManager } from "./ProjectManager";
import { ToolManager, ToolExecutionContext } from "./ToolManager";
...
export class HookManager {
  ...
  private async triggerHooks(
    ...
    const hooks = this.store.projects
      ...
      .filter(
        (h) => !h.condition || this.evaluateCondition(h.condition, context),
      );
