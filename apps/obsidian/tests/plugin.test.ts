...
describe("AuthManager", () => {
  ...
  describe("Active Provider", () => {
    ...
    it("should throw error setting unconfigured provider as active", async () => {
      await expect(
        authManager.setActiveProvider("unconfigured")
  ...
  describe("API Key Validation", () => {
    ...
    it("should validate Gemini API key format", () => {
      expect(
        authManager.validateApiKey("gemini", "abcdefghijklmnopqrst1234567890")
      ).toBe(true);
    ...
    it("should validate Vertex API key format", () => {
      expect(
        authManager.validateApiKey("vertex", "a".repeat(51))
      ).toBe(true);
    ...
    it("should validate CloudShell token format", () => {
      expect(
        authManager.validateApiKey("cloudshell", "header.payload.signature")
      ).toBe(true);
...
describe("SkillManager", () => {
  ...
  describe("Skill Execution", () => {
    ...
    it("should throw error for unknown skill", async () => {
      await expect(
        skillManager.executeSkill("unknown-skill", "input")
