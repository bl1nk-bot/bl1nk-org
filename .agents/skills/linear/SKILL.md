---
name: linear
description: "Linear issue management. MUST USE when: (1) user mentions BLNK-xxx issue IDs (e.g. BLNK-0001), (2) user says 'linear', 'linear issue', 'link linear', (3) creating PRs that reference Linear issues. Provides workflows for retrieving issues, updating status, and adding comments."
---
...
**When creating a PR that references Linear issues (BLNK-xxx), you MUST:**

1. Create the PR with magic keywords (`Fixes BLNK-xxx`)
